    ...
    <div className="space-y-5">
      ...
      <div className="bg-surface border rounded-2xl shadow-sm" style={{ borderColor: 'rgba(30,80,40,0.1)' }}>
        <div className="px-5 py-4 border-b" style={{ borderColor: 'rgba(30,80,40,0.1)' }}>
          ...
          <div className="text-[11px] text-ink3 mt-0.5">Cenizas listas a los 5 días de la cremación · compostaje listo a los 2, 2.5 o 3 meses de ingresar al cubículo (según el cubículo)</div>
        </div>
        {items.length === 0 ? (
