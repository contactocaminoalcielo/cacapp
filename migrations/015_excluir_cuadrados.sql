-- ============================================================================
-- 015 — No volver a cuadrar servicios ya cuadrados (cerrados) · Fase 1.5
-- Fecha: 2026-06-23
--
-- David: una vez se cuadra (cierra) un técnico, esas mascotas/servicios no deben
-- volver a aparecer en otro cuadre. Semántica: el bloqueo es al CERRAR (un
-- BORRADOR sí se puede regenerar libremente). generar_cuadre_tecnico excluye:
--   - recibos cuyo recibo ya está en un cuadre CERRADO,
--   - cancelados cuyo servicio ya está en un cuadre CERRADO.
--
