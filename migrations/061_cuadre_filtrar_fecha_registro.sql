-- 061 — Cuadres técnicos filtrados por fecha de registro del servicio
-- Mantiene fecha_emision/hora_emision para recargos y auditoría; solo alinea
-- el rango solicitado con la fecha que Finanzas muestra al usuario.
